 ...
 * @version 2014-10-27 BufferPool class - maintains data to read and write from
 *          disk
 */
public class BufferPool implements BufferPoolADT {
	...
	/**
	 * @param space
	 *            - the data to insert to the buffer pool
	 * @param sz
	 *            - size of the data to be inserted
	 * @param pos
	...
	/**
	 * @param space
	 *            - the space to write data to
	 * @param sz
	 *            - size of data to get
	 * @param pos
	 *            - position to retrieve data from
	 * @throws IOException
